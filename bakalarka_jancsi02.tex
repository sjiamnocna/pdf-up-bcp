...
\begin{document}
    ...
    \chapter{Technologie a principy vývoje webové aplikace}
        ...
        Obvykle není nutné tvořit aplikaci od začátku. \uv{Pro frontend i backend aplikace existuje na webu obrovské množství použitelných materiálů. Ať už jsou to různé grafické prvky nebo serverové komponenty, to vše je už někde nejspíše hotové.}\cite{itnetworkBestPractices}
