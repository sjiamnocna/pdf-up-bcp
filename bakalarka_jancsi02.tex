...
\begin{document}
	...
	\section{Návrh aplikace}
        ...
        \subsection{Výběr technologií}
            ...
            kromě Reactu také balíček s~příslušnými datovými typy, pro použití v~Typescriptu. Typescript podporuje i~použití JSX šablon, které nám~umožňují vykreslování komponent bez~použití \texttt{React.createElement}\parencite[Refeerence/Handbook/JSX]{TypeScript}
