...
\begin{document}
    ...
    si~ujasnit pár současných i~historických pojmů a~pochopit, jak~spolu souvisí.
        ...
        Tedy jde o nejdelší část životního cyklu aplikace. V~této části je~potřeba aplikaci testovat a~opravovat chyby, které se~vyskytnou.
            ...
            Při kompilaci se~kontroluje správnost kódu a~případné chyby se~oznámí vývojáři. Některé chyby může překladač opravit automaticky a~podle
            závažnosti chyby a~námi zavedených parametrů pro~překlad se~rozhodne, zda~překlad proběhne v~pořádku nebo ne.
