...
\begin{document}
    ...
    \uv{Pro frontend i backend aplikace existuje na webu obrovské množství použitelných materiálů. Ať už jsou to různé grafické prvky nebo serverové komponenty, to vše je už někde nejspíše hotové.}\parencite{itnetworkBestPractices}
        ...
        A \textbf{Javascript} je~sice považován za~\textsc{objektově orientovaný}, nicméně \textsc{OOP} implementuje formou tzv.~\textsc{prototypové dědičnosti}, nikoliv tradičním použitím tříd. V~praxi tak~má~každý objekt definovanou vlastnost \texttt{__proto__}, která buďto obsahuje \textbf{rodičovský objekt} nebo obecný \textbf{prototyp objektů}. \parencite[2.1.01]{kantor_javascript}
