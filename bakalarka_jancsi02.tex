...
\begin{document}
    ...
    \begin{singletonpage}{Prohlášení}
        ...
        Některé části práce jsem konzultoval s~umělou inteligencí (ChatGPT, Bard) pro~doplnění kontextu nebo~kontrolu, ta~však není autorem tohoto textu jako celku.
