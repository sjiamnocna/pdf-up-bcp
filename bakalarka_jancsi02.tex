	...
	\section{Návrh aplikace}
        ...
        \subsection{UML~--~Unified Modeling Language}
            ...
            \subsubsection{UCD~--~Use Case Diagram}
                ...
                \begin{itemize}
                    \item \harddata{Návštěvník} -- zobrazit příklad/test
                    \item \harddata{Uživatel} -- vše, co \emph{návštěvník} + registrace, přihlášení, tvorba a správa otázek, proměnných, testů, kategorií, zobrazit poslední/aktivní přihlášení, odhlášení, přidání přihlašovací metody, změna hesla, deaktivace účtu
                    \item \harddata{Administrátor} -- vše, co \emph{uživatel} + správa ostatních uživatelů, nastavení aplikace, chat s~uživateli
                    \item \harddata{Systém} -- pravidelná kontrola a~odstraňování neaktivních účtů, nevyužívaných proměnných nebo příkladů a~testů, přihlašovacích metod a přístupových tokenů
                \end{itemize}
