...
\begin{document}
    ...
    \chapter{Technologie a principy vývoje webových aplikací}
        ...
        Obvykle není nutné tvořit aplikaci od~začátku (tzv.~\textbf{na~zelené louce}). \uv{Pro~frontend i~backend aplikace existuje na~webu velké množství použitelných materiálů. Ať~už~jsou to~různé grafické prvky nebo~serverové komponenty, to~vše je už~někde nejspíše hotové.}~\cite{itnetworkBestPractices}
