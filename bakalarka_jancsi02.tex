...
\begin{document}
    ...
    \begin{singletonpage}{Prohlášení}
        ...
        Pro~lepší pochopení kontextu byly~některé části práce konzultovány s~umělou inteligencí (ChatGPT, Bard), texty v~této práci jsou~však výsledkem samostatné práce za~použití uvedených zdrojů.
    ...
    \begin{singletonpage}{Poděkování}
        ...
        Chtěl bych touto cestou poděkovat všem, kteří mi~pomohli při~návrhu, tvorbě a~korektuře práce, sběru dat nebo~upřesnění návrhu aplikace. Děkuji také blízkým za~vlídné slovo a~povzbuzení.
        
        Speciální dík patří vedoucímu práce panu {doc.\,RNDr.\,Petru~Šalounovi,\,Ph.D.} za~trpělivost a~ochotu pomoci při~její tvorbě.
        
        Děkuji také~Univerzitě Palackého v~Olomouci za~příspěvek ve~formě stipendia na~pilotní provoz aplikace.
