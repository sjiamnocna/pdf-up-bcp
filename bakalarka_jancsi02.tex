...
\newacronym{html}{HTML}{Hypertext Markup Language}
            ...
            \textbf{\acrshort{html}} (česky \textbf{Hypertextový značkovací jazyk}) je~strukturovaný jazyk, obsahující textový obsah a~hiearchicky strukturované \emph{HTML} značky, které určují význam jednotlivých částí dokumentu.
