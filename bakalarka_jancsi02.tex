...
UPDATE users SET email = 'mujmejl@seznam.cz\', role=\'admin', WHERE id = 42'
	...
	\section{Postup implementace}
        ...
        \subsection{Frontend}
            ...
            \textbf{Router} v~případě \emph{frontendu} určí, která stránka (resp. \emph{komponenta}) bude na~základě \emph{URI} (adresy), \emph{query} parametrů a~stavu okna prohlížeče zobrazena. Veřejné části prezentace budou v~hlavní části \emph{routeru}, na~stránky pro~přihlášené uživatele potom aplikuju tzv.~\emph{lazy loading}.
