...
class dataLoader extends Endpoints{
    ...
    public function actionEndpoint{
        ...
        return JSONResponse({
            ...
            Tuto distribuci používám jako hlavní systém na~svém \textbf{VPS} (Virtual Private Server), kde~aplikace poběží. Na~serveru běží pouze \emph{Nginx}, který nasměruje požadavky na~správné porty, a~\emph{Firewall} (\texttt{UFW}), který zablokuje přístup k~portům, které nechci vystavovat na~veřejnost.
