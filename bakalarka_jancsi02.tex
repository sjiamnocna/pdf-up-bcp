...
\begin{document}
	...
	\section{Návrh aplikace}
        ...
        \textsc{Class diagram} je~také součástí~standardu \textsc{UML}. Zobrazuje třídy, jejich atributy a~metody a~vztahy mezi~nimi.
        ...
        \begin{itemize}
            \item \textbf{Veřejné (public)} vlastnosti a~metody jsou přístupné ostatním třídám a~komukoliv, kdo~má~přístup k~objektu je~může zobrazit či~změnit.
            \item \textbf{Chráněné (protected)} vlastnosti a~metody jsou přístupné jen třídám, které dědí vlastnosti z~třídy, ve~které jsou definovány.
            \item \textbf{Privátní (private)} vlastnosti a~metody jsou přístupné jen třídě, ve~které jsou definovány a~nikdo jiný s~nimi nemůže pracovat.
            \item \textbf{Statické (static)} jsou vlastnosti a~metody, které jsou společné pro~všechny instance třídy a~tedy nejsou přidružené žádnému objektu a~lze~je~používat i~bez inicializace objektu.
        \end{itemize}
        
        Vztahy inkluze a~rozšíření jsou zobrazeny stejně jako u~\textsc{UCD} \parencite{visualparadigmClassDiagram}.
