...
\begin{document}
	...
	\section{Úvod}
    Cílem této práce je~zmapovat nástroje, které učitelé používají pro~tvorbu písemných prací pro~své~žáky. Ve~druhé části popíšu návrh a~implementaci webové aplikace, kterou by~učitelé k~tvorbě různých variant zadání mohli používat.
	...
	\section{Návrh aplikace}
        ...
        Pro naplánování své práce jsem si~vybral diagramy tříd, aktivit a~případů užití.
