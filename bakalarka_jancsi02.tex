...
\begin{document}
    ...
    \begin{singletonpage}{Poděkování}
        Chtěl bych v~této části poděkovat všem, kteří mi asistovali při tvorbě a~korektuře práce, sbírání dat a~zdrojů nebo upřesňování návrhu aplikace. Děkuji také blízkým za~psychickou podporu a~povzbuzení. Speciální dík patří vedoucímu práce panu {doc. RNDr. Petr Šalounovi, Ph.D.} za~trpělivost a~ochotu pomoci při~její tvorbě.\\
