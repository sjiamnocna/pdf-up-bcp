...
\begin{document}
    ...
    \chapter{Technologie a principy vývoje webových aplikací}
        ...
        \section{Kompilátor a interpret}
            ...
            \acrdefprint{JIT}{Just In Time} \textbf{překladač} zrychluje běh interpretovaného kódu překladem do~\textbf{bytecode}, který uloží do~paměti a~v~příštím běhu vykonává instrukce rychleji.
