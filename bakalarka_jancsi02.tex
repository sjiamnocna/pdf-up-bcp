...
const f = fs.open('env_vars.js', 'w', function(err, fd) {
    ...
    \chapter{Závěr}
        ...
        Bohužel jsem po~mnoha pokusech s~pluginy a~konfiguracemi pro~\emph{I18n} zjistil, že~se~v~\emph{NextJS} vyskytuje chyba (viz.~\href{https://github.com/vercel/next.js/issues/21565}{odkaz}), která znemožňuje použití \emph{I18n} s~použitím konfigurace \emph{proxy}. Problém budu~řešit později mimo tuto práci.
