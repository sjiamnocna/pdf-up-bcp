...
func main(){
    // bitový součet (1 + 4 = 5), tj. 00000101
    UP := ReadPermission | ExecutePermission
    
    // bitová maska 00000001
    if (UP & ReadPermission) > 0 {
        fmt.Println("Uživatel může zobrazit soubor")
    }
}
                    \end{minted}
	...
	\chapter{Postup implementace}
        ...
        \subsection{Funkce Main}
            ...
            \begin{description}
                ...
                \item Další \emph{endpointy} viz dokumentace \acrshort{API} v~repozitáři na Gitlabu.
            \end{description}
