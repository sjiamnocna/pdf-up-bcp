...
\begin{document}
    ...
    \chapter{Technologie a principy vývoje webových aplikací}
        ...
        \section{Základní statická HTML stránka}
            V@roce 1989 vytvořil Tim Berners-Lee první webový prohlížeč a~jazyk \emph{HTML}. \textbf{HTML} je~zkratka pro~\textbf{Hypertext Markup Language (Hypertextový značkovací jazyk)}. Základem je~{HTML} soubor, který obsahuje textový obsah a~strukturované \emph{HTML} značky, které určují význam jednotlivých částí.
            
            Jednotlivé soubory lze~také propojit pomocí \textbf{hypertextových odkazů}, které umožňují uživateli kliknutím přecházet z~jedné stránky na~druhou.
