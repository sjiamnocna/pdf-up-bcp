...
class dataLoader extends Endpoints{
	...
	\section{Budoucí rozvoj aplikace}
        ...
        Existují další prostředí, která by využila tvorbu příkladů. Aplikace \emph{Písemkomat} bude dostupná přes~\emph{API}, mohla by~být integrována do~těchto prostředí formou pluginu a~učitelé by~mohli využívat generované příklady např.~v~prostředí \textbf{Moodlu}, nebo~\textbf{MS~Teams}. Možností~je i~integrace do~\textbf{CMS} systémů jako~\textbf{Wordpress} nebo~\textbf{Drupal}.
        ...
        Pro~realizaci výše zmíněných rozšíření je~vhodné získat sponzory, kteří by~přispěli na~vývoji aplikace, což~by~umožnilo věnovat se~vývoji naplno a~lépe rozšiřovat její~funkce. Do~budoucna by~bylo potřeba vývoj rozšířit o~další vývojáře, kteří by~se~podíleli na~vývoji a~rozšiřování aplikace.
	...
	\section{Závěr}
        ...
        V~práci jsem se~snažil používat aktuální technologie a~postupy, které jsou~v~současnosti používány, používat základní poučky pro vývoj aplikací a~psát čitelný, dokumentovaný a~rozšiřitelný kód. Informační technologie se~neustále vyvíjí a~je~nutné kriticky sledovat nové trendy a~technologie, jelikož v~době publikace této práce již~mohou být~některé postupy překonané. Základní principy však zůstanou platné a~je~možné na~nich~stavět.
        ...
        Základ pro~tvorbu moderní aplikace s~překlady a~možností lokálního vývoje pomocí jazyka \emph{Go} a~\emph{Vite} je~volně k~dispozici pod~licencí \textbf{MIT} na~\emph{Gitlabu} \href{https://gitlab.com/sjiamnocna/gormrest}{\texttt{sjiamnocna/gormrest}}.
